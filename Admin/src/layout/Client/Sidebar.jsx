...
const navItems = [
  { name: "Dashboard", path: "/client", icon: <MdDashboard size={22} />, exact: true },
  { name: "Customers", path: "/client/customers?q=all", icon: <FaUser size={22} /> },
          { name: "Groups", path: "/client/groups", icon: <FaUsers  size={22}  /> },

  { name: "Subscription", path: "/client/subscription", icon: <MdSubscriptions size={22}  /> },
    { name: "Reports", path: "/client/reports", icon: <BiSolidReport  size={22}  /> },
   { name: "Settings", path: "/client/settings", icon: <FaGear size={22} /> },
    ...
    <>
      ...
      >
        <div className="p-4">
          ...
          <p className="uppercase text-xs text-gray-200">Client panel</p>
        </div>
